...
const GET_ALL_ACCOUNTS = `
	SELECT id, account_number, account_holder, balance, roles, created_at, updated_at
	FROM accounts
`
...
const INSERT_ACCOUNT = `
	INSERT INTO accounts (account_number, account_holder, balance, roles) 
	VALUES ($1, $2, $3, $4)
	RETURNING id, account_number, account_holder, balance, roles, created_at, updated_at
`
